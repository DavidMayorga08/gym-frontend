<template>
  <div class="app">
    ...
    <div class="info">
      <div class="menu">
        <q-btn class="btn" @click.prevent="listarPagos()" :loading="loading">
          Listar pagos
        ...
        <!-- <q-btn class="btn" @click.prevent="listarPorCliente()" :loading="loading">
          Listar por cliente
          <template v-slot:loading>
            <q-spinner color="primary" size="1em" />
          </template>
        </q-btn> -->
        <q-btn class="btn" @click.prevent="pago()" :loading="loading">
          Crear pago
          <template v-slot:loading>
            <q-spinner color="primary" size="1em" />
          </template>
    ...
    <div :class="registroExitoso ? 'success1' : 'success'">
      ...
      <div class="success__title">Modificación Exitosa</div>
...
let columns = ref([
  ...
  },
  {
    ...
    field: (row) => {
      ...
      return plan ? plan.descripcion : "No encontrado";
    },
  },
  {
    name: "fecha",
...
let modificarPago = async () => {
  ...
  try {
    ...
    await usePagos.putPago(Id.value, pago);
